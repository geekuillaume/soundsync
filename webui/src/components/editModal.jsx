...
import { useTheme, withStyles, Popover, TextField, InputAdornment } from '@material-ui/core';
  ...
  const modal = (
    ...
    >
      ...
      {!renameOpen && <>
        ...
        {/* <PopoverButton disableElevation variant="contained">Hide</PopoverButton> */}
      </>}
    </EditPopover>
  );
  return {
