...
<table width="100%" align="center"><tr>
  <td align="center">
    <h3>Windows</h3>
    <p><a href="https://github.com/geekuillaume/soundsync/releases/download/v0.2.5/soundsync-0.2.5.exe">Download</a></p>
  </td>
  <td align="center">
    <h3>MacOS</h3>
    <p><a href="https://github.com/geekuillaume/soundsync/releases/download/v0.2.5/soundsync-0.2.5.dmg">Download</a></p>
  </td>
  <td align="center">
    <h3>Linux</h3>
    <p><a href="https://github.com/geekuillaume/soundsync/releases/download/v0.2.5/soundsync-amd64-0.2.5.deb">Download (.deb for Ubuntu/Debian)</a></p>
    <p><a href="https://github.com/geekuillaume/soundsync/releases/download/v0.2.5/soundsync-x64-0.2.5.pacman">Download (.pacman for Archlinux)</a></p>
  </td>
  <td align="center">
    <h3>Linux ARM (Raspberry)</h3>
    <p><a href="https://github.com/geekuillaume/soundsync/releases/download/v0.2.5/soundsync-armv7l-0.2.5.deb">Download (.deb for Ubuntu/Debian/Raspbian)</a></p>
  </td>
</tr></table>
