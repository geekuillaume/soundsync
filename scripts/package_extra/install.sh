...
install_help() {
  case $platform in
    systemd) echo "To start this service, use: systemctl start soundsync" ;;
    upstart) echo "To start this service, use: initctl start soundsync" ;;
    launchd) echo "To start this service, use: launchctl start soundsync" ;;
    sysv) echo "To start this service, use: /etc/init.d/soundsync start" ;;
  esac
}
